...
figure(4)
hold on
plot(r,P_allKO_no_sensitivity_simulation(1,1)*100*ones(11,1),linea{5},'LineWidth',lw)
plot(r,P_allKO_no_sensitivity_simulation(1,:)*100,leg{1},'LineWidth',lw,'MarkerSize',ms)
plot(r,P_allKO_no_sensitivity_simulation(2,:)*100,leg{2},'LineWidth',lw,'MarkerSize',ms)
plot(r,P_allKO_sensitivity_simulation(1,1)*100*ones(11,1),linea{6},'LineWidth',lw)
plot(r,P_allKO_sensitivity_simulation(1,:)*100,leg{3},'LineWidth',lw,'MarkerSize',ms)
plot(r,P_allKO_sensitivity_simulation(2,:)*100,leg{4},'LineWidth',lw,'MarkerSize',ms)
...
axis([0 max(r) 10 max(max(P_allKO_sensitivity_simulation))*100]);
