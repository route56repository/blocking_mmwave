...
P_T_B = -5; %Tx power of the BS in dBm.
    P_T_B = 10^(P_T_B/10)/1000;
    
P_T_R = -10; %Tx power of the RS in dBm.
    P_T_R = 10^(P_T_R/10)/1000;
    
S_R = -95; %Sensitivity of the RS in dBm.
    S_R = 10^(S_R/10)/1000;
    
S_U = -95; %Sensitivity of the UE in dBm.
    S_U = 10^(S_U/10)/1000;
    
G_B = 10.6; %BS's gain in dB.
    G_B = 10^(G_B/10);
    
G_R = 5; %RS's gain in dB.
    G_R = 10^(G_R/10);
    
G_U = -1; %UE's gain in dB.
    G_U = 10^(G_U/10);
