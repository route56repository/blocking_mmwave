...
k_added = 40;
theta = 0.1*pi * (rand(k_added, 1)) +  angle_y - pi/8;  % angular coordinates
rho = R * sqrt(rand(k_added, 1));  % radial coordinates
...
exportgraphics(gca,'slice_degenerate_2.pdf','ContentType','vector')